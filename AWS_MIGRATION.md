...
| `/py/*` | `tg-python-lab` | Dispatcher Python con 12 casos internos |
| `/node/*` | `tg-node-lab` | Dispatcher Node con 12 casos internos |
| `/java/*` | `tg-java-lab` | Dispatcher Java con 12 casos internos |
| `/dotnet/*` | `tg-dotnet-lab` | Dispatcher .NET con 12 casos internos |
