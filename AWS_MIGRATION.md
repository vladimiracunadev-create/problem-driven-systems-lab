...
- Estado real del repo a la fecha de este plan: **7 stacks operativos** (PHP, Python, Node, Java, .NET, Go, Rust), **133 endpoints** detrás de 7 hubs simétricos (`:8100`, `:8200`, `:8300`, `:8400`, `:8500`, `:8600`, `:8700`), portal en `:8080` y observabilidad PHP-only en `:9091` / `:3001`.
...
| `/php/*` | `tg-php-lab` | Dispatcher PHP (19 casos internos); casos 01/02 conectan a RDS pg-01/pg-02 |
| `/py/*` | `tg-python-lab` | Dispatcher Python con 19 casos internos |
| `/node/*` | `tg-node-lab` | Dispatcher Node con 19 casos internos |
| `/java/*` | `tg-java-lab` | Dispatcher Java con 19 casos internos |
| `/dotnet/*` | `tg-dotnet-lab` | Dispatcher .NET con 19 casos internos |
