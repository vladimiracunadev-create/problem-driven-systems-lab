...
> Plan operativo y honesto para mover el laboratorio (7 stacks operativos · 20 casos cada uno · 140 endpoints) desde Docker Compose local hacia AWS. Tres rutas alternativas, costos con rango realista, diagramas navegables y un mapping explícito de **cómo AWS cierra cada hallazgo del [SECURITY.md](SECURITY.md) sin tocar código del lab**.
...
| `/php/*` | `tg-php-lab` | Dispatcher PHP (20 casos internos); casos 01/02 conectan a RDS pg-01/pg-02 |
| `/py/*` | `tg-python-lab` | Dispatcher Python con 20 casos internos |
| `/node/*` | `tg-node-lab` | Dispatcher Node con 20 casos internos |
| `/java/*` | `tg-java-lab` | Dispatcher Java con 20 casos internos |
| `/dotnet/*` | `tg-dotnet-lab` | Dispatcher .NET con 20 casos internos |
