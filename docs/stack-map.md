...
> 🧬 **Cada stack tiene su perfil completo en [docs/languages/](languages/README.md)**: para qué sirve el lenguaje, primitivas que usa en los 13 casos, qué mide el laboratorio y cómo reproducirlo, límites documentados y qué revisar cuando publique una versión nueva.
