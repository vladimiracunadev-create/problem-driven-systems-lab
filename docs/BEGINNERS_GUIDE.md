...
> 💡 Los **17 casos están operativos en los 7 stacks**: PHP, Python, Node.js, Java, .NET, Go y Rust. Podés recorrer cualquier caso en cualquiera de ellos.
...
| **Hub** | Un contenedor que sirve los 17 casos de un lenguaje detrás de un puerto (`:8100` PHP, `:8300` Node, …) |
...
| [executive-summary.md](executive-summary.md) | Los 17 casos en una página |
