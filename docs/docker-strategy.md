...
| Patron | Uso |
| --- | --- |
| `compose.root.yml` | Portal + 20 casos PHP en una sola entrada |
| `compose.python.yml` | Hub Python con los 20 casos en un solo contenedor |
| `compose.nodejs.yml` | Hub Node.js con los 20 casos en un solo contenedor |
| `compose.java.yml` | Hub Java 21 con los 20 casos en un solo contenedor |
| `compose.dotnet.yml` | Hub .NET 8 con los 20 casos en un solo contenedor |
