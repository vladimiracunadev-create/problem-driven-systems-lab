...
El laboratorio resuelve **los mismos 17 problemas en 7 lenguajes**. Eso obliga a una pregunta que un repositorio de un solo stack nunca se hace:
...
| 🧰 **Primitivas en el lab** | Qué usa cada uno de los 17 casos, con enlace al código |
...
| [docs/case-catalog.md](../case-catalog.md) | Los 17 casos con su estado real y stacks operativos |
