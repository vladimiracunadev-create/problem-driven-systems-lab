...
| 🧰 **Primitivas en el lab** | Qué usa cada uno de los 20 casos, con enlace al código |
...
| [docs/case-catalog.md](../case-catalog.md) | Los 20 casos con su estado real y stacks operativos |
