...
> **Versión fijada:** `8.3` · **Imagen base:** `php:8.3-cli-alpine` (portal: `php:8.3-apache`) · **Hub:** `:8100` · **Casos operativos:** 17 / 17
...
Agregado de los veredictos de las 16 comparativas que rankean: **0 primeros puestos, media 5.7** — el promedio más bajo del set.
...
Levanta el portal, los 17 casos PHP en `http://localhost:8100/NN/`, PostgreSQL, Prometheus y Grafana. Es la entrada más completa del laboratorio y la recomendada para una primera evaluación.
