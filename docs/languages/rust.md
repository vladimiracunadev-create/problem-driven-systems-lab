...
> **Versión fijada:** `1.83` · **Imagen base:** `rust:1.83-alpine` · **Hub:** `:8700` · **Casos operativos:** 12 / 12
...
Agregado de los veredictos de las 11 comparativas que rankean: **6 primeros puestos, media 1.9** — más oros que ningún otro stack.
...
Los 12 casos quedan servidos en `http://localhost:8700/NN/`. La primera compilación es notablemente más lenta que la de los otros seis stacks — es esperable, no es un fallo del build.
