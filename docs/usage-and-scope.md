...
| Area | Estado actual |
| --- | --- |
| 19 casos definidos y documentados | si |
...
| Paridad funcional completa entre todos los lenguajes | si — los 7 stacks (PHP/Python/Node/Java/.NET/Go/Rust) cubren los 19 casos cada uno con primitivas idiomaticas distintas |
