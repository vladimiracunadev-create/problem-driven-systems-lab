...
Los 16 casos de este laboratorio no resuelven problemas con código genérico: los resuelven con **la primitiva idiomática de cada runtime**. Esa es toda la propuesta de valor del repositorio, y también su punto de caducidad.
...
- [ ] **6. `Dockerfile`** — los 16 casos del stack **y** el hub. Uno solo desalineado y el mismo caso corre en dos runtimes según cómo se levante.
...
- Dockerfile de los 16 casos + hub, cases.json, README y stack-map
