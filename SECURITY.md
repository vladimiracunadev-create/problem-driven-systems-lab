...
| **Inyección de scenario / consumer / domain** | Allowlist estricto en los 20 casos: `if (!ALLOWED.includes(x)) x = default`. Equivalente con `in_array(...)` en PHP. | Todos los casos |
