...
Los siete stacks pueden correr en paralelo sin colisión de puertos. **PHP/Python/Node/Java/.NET/Go/Rust sirven 14 casos cada uno desde `:8100`/`:8200`/`:8300`/`:8400`/`:8500`/`:8600`/`:8700`. 98 endpoints operativos detras de 7 hubs.**
...
| Componente | URL | Senal esperada |
| --- | --- | --- |
| Java hub — índice | `http://localhost:8400/` | Lista de los 14 casos JSON |
...
| Componente | URL | Senal esperada |
| --- | --- | --- |
| .NET hub — índice | `http://localhost:8500/` | Lista de los 14 casos JSON |
...
| Go hub — índice | `http://localhost:8600/` | Lista de los 14 casos JSON |
| Casos 01–12 Go | `http://localhost:8600/01/health` … `http://localhost:8600/12/health` | Respuesta saludable |
| Rust hub — índice | `http://localhost:8700/` | Lista de los 14 casos JSON |
