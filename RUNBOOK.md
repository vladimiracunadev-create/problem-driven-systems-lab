...
| Componente | URL | Senal esperada |
| --- | --- | --- |
| Java hub — índice | `http://localhost:8400/` | Lista de los 20 casos JSON |
...
| Componente | URL | Senal esperada |
| --- | --- | --- |
| .NET hub — índice | `http://localhost:8500/` | Lista de los 20 casos JSON |
...
| Go hub — índice | `http://localhost:8600/` | Lista de los 20 casos JSON |
| Casos 01–12 Go | `http://localhost:8600/01/health` … `http://localhost:8600/12/health` | Respuesta saludable |
| Rust hub — índice | `http://localhost:8700/` | Lista de los 20 casos JSON |
