...
- 5+ años de experiencia traducidos en **evidencia operativa**: 15 problemas reales × 7 stacks de producción = **105 endpoints verificables**.
...
Vas a ver: tabla de estado actual (7 stacks operativos, 105 endpoints), catálogo de los 15 casos con links, tabla de honestidad de fidelidad, los 7 hubs disponibles.
...
| [docs/executive-summary.md](docs/executive-summary.md) | Los 15 casos en una página + postmortems narrativos |
