...
- 5+ años de experiencia traducidos en **evidencia operativa**: 20 problemas reales × 7 stacks de producción = **140 endpoints verificables**.
...
Vas a ver: tabla de estado actual (7 stacks operativos, 140 endpoints), catálogo de los 20 casos con links, tabla de honestidad de fidelidad, los 7 hubs disponibles.
...
| [docs/executive-summary.md](docs/executive-summary.md) | Los 20 casos en una página + postmortems narrativos |
