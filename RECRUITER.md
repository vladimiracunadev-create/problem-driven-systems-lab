...
- 5+ años de experiencia traducidos en **evidencia operativa**: 17 problemas reales × 7 stacks de producción = **119 endpoints verificables**.
...
Vas a ver: tabla de estado actual (7 stacks operativos, 119 endpoints), catálogo de los 17 casos con links, tabla de honestidad de fidelidad, los 7 hubs disponibles.
...
| [docs/executive-summary.md](docs/executive-summary.md) | Los 17 casos en una página + postmortems narrativos |
