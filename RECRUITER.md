...
- 5+ años de experiencia traducidos en **evidencia operativa**: 14 problemas reales × 7 stacks de producción = **98 endpoints verificables**.
...
Vas a ver: tabla de estado actual (7 stacks operativos, 98 endpoints), catálogo de los 14 casos con links, tabla de honestidad de fidelidad, los 7 hubs disponibles.
...
| [docs/executive-summary.md](docs/executive-summary.md) | Los 14 casos en una página + postmortems narrativos |
