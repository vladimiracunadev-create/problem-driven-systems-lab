...
- 5+ años de experiencia traducidos en **evidencia operativa**: 16 problemas reales × 7 stacks de producción = **112 endpoints verificables**.
...
Vas a ver: tabla de estado actual (7 stacks operativos, 112 endpoints), catálogo de los 16 casos con links, tabla de honestidad de fidelidad, los 7 hubs disponibles.
...
| [docs/executive-summary.md](docs/executive-summary.md) | Los 16 casos en una página + postmortems narrativos |
